...
static u32 _checkPromoCode(u32);
...
static u32 _checkPromoCode(u32 p0) {
...
static const u8 data_segment_data_0[] = {
  0xc1, 0xf2, 0x74, 0x68, 0xf3, 0x51, 0xbc, 0xf0, 0x00, 0x87, 0xab, 0x8a, 
  0xa0, 0xd1, 0x57, 0xe3, 0xde, 0x71, 0x12, 0xf3, 0x72, 0x85, 0xeb, 0x2f, 
  0x87, 0xa7, 0xab, 0xab, 0xff, 0x74, 0x00, 0x00, 0x48, 0x56, 0x31, 0x38, 
  0x2d, 0x54, 0x52, 0x59, 0x48, 0x2d, 0x41, 0x52, 0x44, 0x45, 0x2d, 0x52, 
  0x54, 0x52, 0x59, 0x5f, 0x48, 0x41, 0x52, 0x44, 0x5f, 0x45, 0x52, 0x21, 
  ...
  0xc8, 0x04, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
static void init_memory(void) {
  memcpy(&((*Z_envZ_memory).data[1024u]), data_segment_data_0, 190);
}

static void init_table(void) {
  uint32_t offset;
  offset = (*Z_envZ_tableBaseZ_i);
  (*Z_envZ_table).data[offset + 0] = (wasm_rt_elem_t){func_types[1], (wasm_rt_anyfunc_t)(&f45)};
  (*Z_envZ_table).data[offset + 1] = (wasm_rt_elem_t){func_types[1], (wasm_rt_anyfunc_t)(&f25)};
  (*Z_envZ_table).data[offset + 2] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f46)};
  (*Z_envZ_table).data[offset + 3] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f46)};
  (*Z_envZ_table).data[offset + 4] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f31)};
  (*Z_envZ_table).data[offset + 5] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f27)};
  (*Z_envZ_table).data[offset + 6] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f26)};
  (*Z_envZ_table).data[offset + 7] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f46)};
  (*Z_envZ_table).data[offset + 8] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f46)};
  (*Z_envZ_table).data[offset + 9] = (wasm_rt_elem_t){func_types[0], (wasm_rt_anyfunc_t)(&f46)};
}

/* export: '___errno_location' */
u32 (*WASM_RT_ADD_PREFIX(Z____errno_locationZ_iv))(void);
/* export: '_checkPromoCode' */
u32 (*WASM_RT_ADD_PREFIX(Z__checkPromoCodeZ_ii))(u32);
/* export: '_fflush' */
...
static void init_exports(void) {
  ...
  /* export: '_checkPromoCode' */
  WASM_RT_ADD_PREFIX(Z__checkPromoCodeZ_ii) = (&_checkPromoCode);
  /* export: '_fflush' */
