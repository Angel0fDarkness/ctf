...
try:
    ...
    print "Nonce XOR: {}".format(nonce)
except: pass

time.sleep(2)

try:
    ret = urllib2.urlopen(base64.b64decode('aHR0cDovL2NoYWxsZW5nZXMuaGFja3ZlbnQuaGFja2luZy1sYWIuY29tOjgwODEvP25vbmNl'), data='nonce=' + nonce).read()
